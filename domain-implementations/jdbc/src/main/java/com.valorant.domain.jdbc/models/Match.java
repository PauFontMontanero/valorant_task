 ...
 * Implements the {@link com.valorant.models.Match} interface and Serializable for object serialization.
 */
public class Match implements com.valorant.models.Match, Serializable {
     ...
     *
     * @param playedOn the date and time when the match was played.
     */
    @Override
     ...
     *
     * @return the identifier of the map associated with the match.
     */
    @Override
    public int getMapId() {
        return mapId;
     ...
     *
     * @param mapId the identifier of the map associated with the match.
     */
    @Override
